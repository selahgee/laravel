...
<body x-data="{ isCollapsedMenuOpen: false, isProfileMenuOpen: false, notificationsCount: 0 }" x-init="fetchNotificationsCount()">
    <nav class="navbar">
        <div class="collapsed-content">
            ...
            <ul class="collapsed-menu" x-show="isCollapsedMenuOpen" @click.away="isCollapsedMenuOpen = false">
                ...
                <li class="sub-item">
                    ...
                    <a href="{{ route('ambulance.booking.form') }}">Book Ambulance</a>
                    @endif
                </li>
                 <!-- messages -->
            <li class="sub-item">
        ...
        <ul class="right-icons">
            ...
            <!-- Profile Dropdown -->
            <li>
                <img src="{{ Auth::user()->photo ? asset('storage/' . Auth::user()->photo) : asset('images/avatar.jpg') }}" class="profile" @click="isProfileMenuOpen = !isProfileMenuOpen" />
