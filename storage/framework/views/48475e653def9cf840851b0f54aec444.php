...
#editPatientForm .btn-primary:hover {
    ...
    <form id="editPatientForm" action="<?php echo e(route('admin.patient.update', $patient->id)); ?>" method="POST">
            <?php echo csrf_field(); ?>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="passport" name="passport" value="<?php echo e($patient->passport); ?>">
        </div>
        ...
        <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="allergies" name="allergies" value="<?php echo e($patient->allergies); ?>">
            </div>
            <div class="mb-3">
                    <label for="disabilities" class="form-label">Disabilities</label>
                    <input type="text" class="form-control" id="disabilities" name="disabilities"  value="<?php echo e($patient->disabilities); ?>">
                </div>
                
                <button type="submit" class="btn btn-primary">Save changes</button>
    </form>
   <?php /**PATH C:\Users\GEE\Desktop\ambulance-booking-system\resources\views/admin/patient/edit.blade.php ENDPATH**/ ?>